...
public interface FrontEndClinica {
    ...
    @WebMethod(operationName = "locClinica_Server")
    @RequestWrapper(localName = "locClinica_Server", targetNamespace = "http://default_package/", className = "default_package.LocClinicaServer")
    @ResponseWrapper(localName = "locClinica_ServerResponse", targetNamespace = "http://default_package/", className = "default_package.LocClinicaServerResponse")
    @WebResult(name = "return", targetNamespace = "")
    public java.lang.String locClinicaServer(
